...
reqs: ## Update all requirements with pip-compile
	pip-compile --upgrade --resolver=backtracking pyproject.toml -o requirements/requirements.txt
	pip-compile --upgrade --resolver=backtracking pyproject.toml --extra dev -o requirements/development.txt
