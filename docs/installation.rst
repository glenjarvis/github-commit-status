...
This is the preferred method to install github_commit_status, as it will always install the most recent stable release.
...
The sources for github_commit_status can be downloaded from the `Github repo`_.
