...
6.  Decide if you wish to use Poetry.

    It will do a reasonable job of keeping the dependencies for this
...
- The pull request should work for Python 3.10, 3.11, 3.12, 3.13, and for
